...
public class DataInitializr implements ApplicationListener<ContextRefreshedEvent>{
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		switch(opcao) {			
			...
			case 5:
				...
				break;
			case 6:
				consultarPorNome("michele");
				break;
			case 7:
				consultarPoNomeIgnoreCaseLike("ma");
				break;
			case 8:
				consultarPorEmailUsuario("chele53@hotmail.com");
				break;
			default:
	...
	private void consultarPorEmailUsuario(String email) {
		List<Usuario> listaUsuario = userRepository.findByEmailUsuario(email);
	...
	private void consultarPoNomeIgnoreCaseLike(String nome) {
		List<Usuario> listaUsuario = userRepository.findByNomeIgnoreCaseLike(nome);		
	...
	private void consultarPorNome(String nome) {
		List<Usuario> listaUsuario = userRepository.findByNomeIgnoreCase(nome.toUpperCase());
